...
\COPY tmp_table (nom_prestataire, email_prestataire, site_web_prestataire, site_security, telephone_prestataire, passwd_prestataire, etat_inscription, id_stand, id_type, text_gauche, text_droite, url_image, image_body) FROM 'C:\Users\mlcra\SAE-S3\BDD\PRESTATAIRE.csv' DELIMITER AS ',';
...
\COPY COURSES (libelle_course, nb_km, nb_place, prix, trace, url_image, date_periode, id_sport, id_lieu) FROM 'C:\Users\mlcra\SAE-S3\BDD\COURSES.csv' DELIMITER AS '*';
select * from COURSES;
