...
const getPrestataire = (type, callback) => {
    ...
    if (type === "restaurants"){
        getPrestataire = [
            {
                "title": "Mcdo", "filtres": {"Spécialites": "Nuggets", "Places": "200 places"},
            ...
            {
                "title": "Burger King", "filtres": {"Spécialites": "Burger", "Places": "100 places"},
                "url": "https://upload.wikimedia.org/wikipedia/commons/thumb/c/cc/Burger_King_2020.svg/langfr-300px-Burger_King_2020.svg.png"
            },
            {
                "title": "Subway", "filtres": {"Spécialites": "Burger", "Places": "50 places"},
        ...
        getPrestataire = [
            ...
            },
            {
                ...
                "filtres": {
                    "Sport": "Karting",
                    "Date création": "1970",
                    "Localisation": "Le Castellet (83330)",
                    "Niveau": "Loisirs"
                },
