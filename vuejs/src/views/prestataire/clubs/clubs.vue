              ...
              <div class="dropdown">
                ...
                <div class="dropdown-menu">
                  ...
                  <div class="dropdown-item">
                    <a><input type="radio" name="option" value="{{this}}"> {{ this }}</a>
                  </div>
                  {{ /each }}
                </div>
              </div>
        ...
        <div class="card">
          <div class="card-horizontal">
            ...
            <div class="card-body">
              ...
              {{ /each }}
              <form id="club_form" method="POST" action="/club">
                <input id="club" name="club" value="{{this.[3]}}" type="hidden">
                <button class="btn btn-primary">Voir la page</button>
              </form>
            </div>
          </div>
        </div>
