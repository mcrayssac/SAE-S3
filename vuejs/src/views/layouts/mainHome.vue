  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        <li class="nav-item">
          <a class="nav-link active" href="/"><i class="bi bi-geo-alt-fill"></i> Map</a>
        </li>
        ...
        <li class="nav-item dropdown active">
          <a class="nav-link dropdown-toggle" href="/" id="navbarDropdown" role="button"
             data-toggle="dropdown"><i class="bi bi-list-check"></i> Activités</a>
          <div class="dropdown-menu">
            <a class="dropdown-item" href="#">Initiation/Scène</a>
            <a class="dropdown-item" href="/courses">Compétitions</a>
          </div>
        </li>
        <li class="nav-item dropdown active">
          <a class="nav-link dropdown-toggle" href="/" id="navbarDropdown" role="button"
...
<div class="footer-basic">
  <footer>
    <div class="social"><a href="https://github.com/mcrayssac/SAE-S3" target="_blank"><i class="bi bi-github"></i></a>
      <a href="mailto:maxime.crayssac@edu.univ-fcomte.fr" target="_blank"><i class="bi bi-envelope-fill"></i></a>
