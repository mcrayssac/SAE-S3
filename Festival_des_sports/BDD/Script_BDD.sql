...
CREATE TABLE IF NOT EXISTS DONNEES (
   id_donnees INT UNSIGNED AUTO_INCREMENT NOT NULL,
   libelle_donnees VARCHAR(50),
   PRIMARY KEY (id_donnees)
) CHARACTER SET utf8;

CREATE TABLE IF NOT EXISTS TYPE_PRESTATAIRE (
   id_type INT UNSIGNED AUTO_INCREMENT NOT NULL,
...
CREATE TABLE IF NOT EXISTS STAND (
   id_stand INT UNSIGNED AUTO_INCREMENT NOT NULL,
...
CREATE TABLE IF NOT EXISTS ORGANISATEUR (
   id_organisateur INT UNSIGNED AUTO_INCREMENT NOT NULL,
...
CREATE TABLE IF NOT EXISTS LIEU (
   id_lieu INT UNSIGNED AUTO_INCREMENT NOT NULL,
   libelle_lieu VARCHAR(50),
   PRIMARY KEY (id_lieu)
) CHARACTER SET utf8;

CREATE TABLE IF NOT EXISTS SPORT (
   id_sport INT UNSIGNED AUTO_INCREMENT NOT NULL,
...
CREATE TABLE IF NOT EXISTS RESERVATION (
   id_reservation INT UNSIGNED AUTO_INCREMENT NOT NULL,
...
CREATE TABLE IF NOT EXISTS ATTRIBUE (
   ...
   id_donnees INT UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS PRESTATAIRE (
   id_prestataire INT UNSIGNED AUTO_INCREMENT NOT NULL,
...
CREATE TABLE IF NOT EXISTS COURSES (
   id_course INT UNSIGNED AUTO_INCREMENT NOT NULL,
...
CREATE TABLE IF NOT EXISTS INITIATION (
   id_initiation INT UNSIGNED AUTO_INCREMENT NOT NULL,
...
CREATE TABLE IF NOT EXISTS BIENS (
   id_bien INT UNSIGNED AUTO_INCREMENT NOT NULL,
...
CREATE TABLE IF NOT EXISTS COMMENTAIRE (
   id_commentaire INT UNSIGNED AUTO_INCREMENT NOT NULL,
...
CREATE TABLE IF NOT EXISTS Fait (
   id_public INT UNSIGNED NOT NULL,
   id_initiation INT UNSIGNED NOT NULL,
