...
const getRestaurants = (callback) => {
    let getRestaurants = [
        ["Mcdo", {"Spécialites":"Nuggets", "Places":"200 places"},
            "https://upload.wikimedia.org/wikipedia/commons/thumb/3/36/McDonald%27s_Golden_Arches.svg/410px-McDonald%27s_Golden_Arches.svg.png"],
        ["Burger King",{"Spécialites":"Burger", "Places":"100 places"},
            "https://upload.wikimedia.org/wikipedia/commons/thumb/c/cc/Burger_King_2020.svg/langfr-300px-Burger_King_2020.svg.png"],
        ["Subway",{"Spécialites":"Burger", "Places":"50 places"},
            "https://www.enpaysdelaloire.com/sites/default/files/styles/sit/public/sit/images/RESPDL085V503N53/Subway-Logo.jpg?itok=RZcLrk3g"],
        ["KFC",{"Spécialites":"Nuggets", "Places":"50 places"},
            "https://upload.wikimedia.org/wikipedia/fr/thumb/b/bf/KFC_logo.svg/langfr-420px-KFC_logo.svg.png"],
        ["Fatburger",{"Spécialites":"Burger", "Places":"50 places"},
            "https://play-lh.googleusercontent.com/qIzwUnjAzRjlMo-zJecA4C8u7mHq0Dj_wE2GClyDv7iLFIk2tTJdNHzv03933KljZE0"],
        ["Five Guys",{"Spécialites":"Burger", "Places":"10 places"},
            "https://dynl.mktgcdn.com/p/eCdSZKzdeZNQFV4AiM1Z3cDCeBb4ePRc9gxz4JXSmGA/2521x2521.jpg"]
    ];
...
const getFiltresClubs = (type, callback) => {
    ...
    if (type === "restaurants"){
        getFiltres = {
            "Sport":["Basket", "Badminton", "Escrime", "Tir à l'arc", "Natation", "Volley-Ball", "Karting"],
...
const getClubs = (callback) => {
    let getRestaurants = [
        ...
        ["SCE Stade Clermontois Escrime",
            ...
            "https://stade-clermontois-escrime.com/wp-content/uploads/2014/06/cropped-logo-page-acceuil-2.png",
            "SCE"],
        ["FFTA Fédération Française Tir à l'Arc",
            ...
            "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8c/Logo_FFTA_Quadri.png/800px-Logo_FFTA_Quadri.png",
            "FFTA"],
        ["CNM Club Natation Marseille",
            {"Sport":"Natation", "Date création":"1921", "Localisation":"Marseille (13000)", "Niveau":"National/Compétition"},
            "https://upload.wikimedia.org/wikipedia/fr/thumb/6/60/Logo_CNM.svg/1200px-Logo_CNM.svg.png"],
        ["TVB Tours Volley-Ball",
            {"Sport":"Volley-Ball", "Date création":"1940", "Localisation":"Tours (37000)", "Niveau":"National/Compétition"},
            "https://upload.wikimedia.org/wikipedia/fr/thumb/1/15/ToursVBlogo2020.svg/langfr-270px-ToursVBlogo2020.svg.png"],
    ...
    if (club === "JDA"){
        getClub = {
            ...
            "Texte":{"Gauche":["La Jeanne d’Arc a été créée en janvier 1880  sous la forme d’un patronage par l’abbé Bizouard. Ce fut, compte tenu du succès du nombre d’adhérents, un déménagement dans le quartier de la plaine des roses dans la rue Lacodaire.",
                ...
                "Droite":"Suite à une erreur dans un article de presse, un journaliste avait mentionné et abrégé JDA  au lieu de Jeanne d’Arc. C’est ainsi que JDA restera par la suite la dénomination et le logo du club."},
        ...
        getClub = {
            ...
            "Texte":{"Gauche":["La Fédération française de tir à l'arc (FFTA) est chargée d'organiser et de développer la pratique du tir à l'arc en France3. Elle regroupe l’ensemble des clubs faisant pratiquer le tir à l'arc et organise chaque année les championnats de France.",
