...
const getClub = (club, callback) => {
    ...
    if (club === "JDA"){
        getClub = {
            ...
            "Image":"https://upload.wikimedia.org/wikipedia/commons/thumb/0/01/JDA_Dijon_Basket.png/1200px-JDA_Dijon_Basket.png",
            "Texte":"La Jeanne d’Arc a été créée en janvier 1880 sous la forme d’un patronage par l’abbé Bizouard dans un premier temps rue St Philibert (aujourd’hui rue Condorcet) puis ce fut, compte tenu du succès du nombre d’adhérents, un déménagement dans le quartier de la plaine des roses dans la rue Lacodaire.\n" +
                "\n" +
